      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-xl border border-gray-100">
                ...
                <input 
                  type="date" 
                  className="bg-transparent border-none outline-none text-xs text-gray-600"
                  value={startDate}
        ...
        {(startDate || endDate || searchQuery) && (
          <div className="mb-6 flex items-center gap-2 text-sm text-gray-500 italic">
            <Filter size={14} />
            Menampilkan {filteredItems.length} hasil untuk filter yang diterapkan.
          </div>
        )}
          ...
          {filteredItems.length > 0 ? (
            ...
            <div className="bg-white rounded-2xl p-12 text-center border border-gray-100 shadow-sm">
              ...
              {(startDate || endDate || searchQuery) && (
                <button 
                  onClick={clearFilters}
                  className="mt-4 text-[var(--ma-gold)] font-bold hover:underline"
                >
                  Hapus semua filter
                </button>
              )}
